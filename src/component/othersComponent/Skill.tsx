                ...
                <div className="skill_grid"> 
                    <div className="skill_card">
                        ...
                        <div className="inner_card">
                            ...
                            <SkillsCard src='https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg' skillname="tailwind css" />
                        </div>
                    </div>
                    ...
                    <div className="skill_card">
                        <h3>Backend</h3>
                        <div className="inner_card">
                        <SkillsCard src='https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/prisma/prisma-original.svg' skillname="Prisma" />
                        <SkillsCard src='https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postgresql/postgresql-original.svg' skillname="PostgreSQL" />
                        </div>
